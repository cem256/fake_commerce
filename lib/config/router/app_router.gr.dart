...
class AppRouter extends _i10.RootStackRouter {
  ...
  final Map<String, _i10.PageFactory> pagesMap = {
    ...
    ChangePasswordRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i6.ChangePasswordView());
    },
    StoreRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i7.StoreView());
    },
    ShoppingCartRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.ShoppingCartView());
    },
  ...
  List<_i10.RouteConfig> get routes => [
        ...
        _i10.RouteConfig(NavbarRoute.name, path: '/', children: [
          ...
          _i10.RouteConfig(ShoppingCartRoute.name,
        ...
        _i10.RouteConfig(CategoryDetailRoute.name,
